pub fn solve(input: &Vec<Vec<char>>) {
 ...
 fn check_right_down(input: &Vec<Vec<char>>, x: usize, y: usize) -> bool {
     (input[y][x] == 'M' && input[y + 1][x + 1] == 'A' && input[y + 2][x + 2] == 'S') || (input[y][x] == 'S' && input[y + 1][x + 1] == 'A' && input[y + 2][x + 2] == 'M')
 }

 fn check_left_down(input: &Vec<Vec<char>>, x: usize, y: usize) -> bool {
     (input[y][x + 2] == 'M' && input[y + 1][x + 1] == 'A' && input[y + 2][x] == 'S') || (input[y][x + 2] == 'S' && input[y + 1][x + 1] == 'A' && input[y + 2][x] == 'M')
 }